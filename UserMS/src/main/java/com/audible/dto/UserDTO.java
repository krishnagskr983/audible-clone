...
public class UserDTO {
	...
	@NotNull(message="{user.userPhoto.notPresent}")
	private UserFileDTO userPhotoDTO;

	public UserDTO(){}
	public UserDTO(String fullName, String emailId, String contactNumber, String password, String gender, LocalDate dateOfBirth) {
